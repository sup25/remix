...
export const DropdownMenu = () => {
  ...
  return (
    <div ref={menuRef} className="hidden md:flex gap-2">
      {menuItems.map((menuItem, menuIndex) => (
        <div key={menuIndex} className="relative">
          <button
            ...
            className={`
              group inline-flex items-center px-4 py-2 text-sm font-medium rounded-md
              ...
              >
                {menuItem.items.map((item, itemIndex) => (
                  <Link
                    ...
                    className={`
                      flex items-center justify-between px-4 py-3 my-1 text-sm
